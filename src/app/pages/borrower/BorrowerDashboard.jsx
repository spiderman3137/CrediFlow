...
export function BorrowerDashboard() {
  ...
  const statsData = [
    ...
    { name: 'Remaining Balance', value: '$' + userLoans.reduce((s, l) => s + l.amount, 0).toLocaleString(), icon: DollarSign, color: '#FF4D4F' },
    { name: 'Next EMI Due', value: userLoans[0]?.createdAt ? new Date(userLoans[0].createdAt).toLocaleDateString() : '-', icon: Calendar, color: '#FFA940' },
    { name: 'Total Paid', value: '$0', icon: TrendingUp, color: '#28C76F' },
  ];
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-orange-700 mb-3">
              Your next EMI of <strong>$562.50</strong> is due on <strong>March 5, 2026</strong>
            </p>
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="font-bold text-green-600">$6,750</span>
              </div>
              <div className="h-2 bg-gray-200">
                <div className="h-2 bg-green-600" style={{ width: '27%' }}></div>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="font-bold text-red-600">$18,450</span>
              </div>
              <div className="h-2 bg-gray-200">
                <div className="h-2 bg-red-600" style={{ width: '73%' }}></div>
              </div>
            </div>
              ...
              {userLoans.length === 0 ? (
                ...
                userLoans.map((loan) => (
                  <tr key={loan.id}>
                    ...
                    <td className="font-semibold text-gray-900">-</td>
